Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage     = "https://github.com/iballistix/microsoft-authentication-library-for-objc"
  s.license      = { 
    :type => "MIT", 
    :file => "LICENSE" 
  }
  ...
  s.source       = { 
    :git => "https://github.com/iballistix/microsoft-authentication-library-for-objc.git",
    :tag => s.version.to_s,
    :submodules => true
  }
